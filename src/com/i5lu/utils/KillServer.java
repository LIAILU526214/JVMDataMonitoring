...
public class KillServer {
    ...
    public static void main(String[] args) throws InterruptedException {
        System.out.println("请输入要�?掉的windows进程的端口号，如果有多个，则以�?�号相隔");
        ...
        for (String spid : split) {
            try{
                ...
                System.out.println("错误的端口号，请输入�?个或者多个端口，以英文�?�号隔开");
                try {
                    Thread.sleep(5000);
    ...
    /**
     * 验证此行是否为指定的端口，因�? findstr命令会是把包含的找出来，例如查找80端口，但是会�?8099查找出来
     * @param str
     * @return
     */
    private static boolean validPort(String str){
        ...
        if(KillServer.ports.contains(port)){
            return true;
        }else{
            return false;
        }
